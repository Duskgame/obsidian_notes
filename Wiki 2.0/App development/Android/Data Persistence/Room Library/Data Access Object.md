...
**Note**: `Flow` in Room database can keep the data _up-to-date_ by emitting a notification whenever the data in the database changes. This allows you to observe the data and update your UI accordingly.
