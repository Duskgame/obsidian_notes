...
- Room [Database class](https://developer.android.com/reference/kotlin/androidx/room/Database) is the database [[Kotlin Class|Class]] that provides your app with instances of the DAOs associated with that database.
