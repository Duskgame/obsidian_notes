In this task, you implement the [[ItemsRepository]] Interface and [[OfflineItemsRepository]] [[Kotlin]] Class to provide `get`, `insert`, `delete`, and `update` entities from the [[Database]].
...
4. Pass in a Kotlin Constructor Parameter of the type [[ItemDao]].
