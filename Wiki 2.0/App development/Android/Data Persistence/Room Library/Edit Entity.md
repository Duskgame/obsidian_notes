...
6. Add a [[Kotlin Constructor|constructor]] [[Parameter]] to the [[ItemEditViewModel]] class.
...
7. In the [[AppViewModelProvider]].kt file, in the [[ItemEditViewModel]] initializer, add the `ItemsRepository` [[Kotlin Object|Object]] as an argument.
