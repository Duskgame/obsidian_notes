...
---
**STARTTLS** ist eine Protokollerweiterung, die es ermöglicht, eine zunächst unverschlüsselte Verbindung nachträglich auf eine verschlüsselte [[Transport Layer Security (TLS)|TLS]]-Verbindung hochzustufen (*Upgrade*).
